...
void pre_auton(void)
{
  ...
  {                             // Changing the names below will only change their names on the
    ...
    case 0:
      Brain.Screen.printAt(50, 50, "skills Test");
      break;
    case 1:
...
void autonomous(void)
{
  ...
  case 1:  // Tap the screen to cycle through autons.
    ...
    break;
  case 2:
    matchauton();// This is the default auton, if you don't select from the brain.
    break;
  case 3:
    skills_462B();
    break;
...
void usercontrol(void)
{
  ...
  while (1)
  {
    ...
    if (Controller1.ButtonR2.pressing())
    {
      ...
      intakeA.spin(fwd, 100, percent);
    }
    else if (Controller1.ButtonR1.pressing())
    {
      intakeB.spin(fwd, 100, percent);
    ...
    // sweeeeeeeep
    if (Controller1.ButtonL2.pressing() && !pneumButtonPress3)
    {
